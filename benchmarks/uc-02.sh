...
info ""
info "Next: bash benchmarks/uc-03.sh   # home automation (requires HA instance)"
info "  or: bash benchmarks/uc-04.sh   # data analyst (Docker Postgres used)"
echo ""
