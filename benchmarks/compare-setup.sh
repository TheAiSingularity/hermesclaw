...
#
# Usage:
#   ./benchmarks/compare-setup.sh
#   ./benchmarks/compare-setup.sh --model /path/to/model.gguf
...
if [[ -n "$EXISTING_MODEL" ]]; then
    ...
    echo "  Then re-run: ./benchmarks/compare-setup.sh"
    echo "  Or: ./benchmarks/compare-setup.sh --model /path/to/model.gguf"
    echo ""
...
echo "  bash benchmarks/uc-01.sh   # researcher"
echo "  bash benchmarks/uc-02.sh   # developer"
echo "  bash benchmarks/uc-04.sh   # data analyst"
echo "  bash benchmarks/uc-05.sh   # small business"
echo "  bash benchmarks/uc-06.sh   # privacy-regulated"
echo "  bash benchmarks/uc-07.sh   # trader"
echo ""
