...
]' | docker exec -i hermesclaw python3 /opt/data/skills/anomaly-detection/scripts/detect.py 2>/dev/null || echo "")
...
echo ""
info "Next: bash benchmarks/uc-05.sh   # small business (Slack)"
echo ""
